...
from nscs.crdserver.common import exceptions as exception
from nscs.crdserver import context
from nscs.crdserver.openstack.common import jsonutils
...
class Request(webob.Request):
    ...
    @property
    def context(self):
        if 'nscs.crdserver.context' not in self.environ:
            self.environ['crd.context'] = context.get_admin_context()
        return self.environ['nscs.crdserver.context']
