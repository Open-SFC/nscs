...
from nscs.crdserver.common.exceptions import ClassNotFound
from nscs.crdserver.openstack.common import importutils
from nscs.crdserver.openstack.common import lockutils
from nscs.crdserver.openstack.common import log as logging
from nscs.crdserver.openstack.common import periodic_task
...
class CrdManager(object):
    """
    Crd's Manager class is responsible for parsing a config file and
    instantiating the correct plugin that concretely implement
    crd_plugin_base class.
    The caller should make sure that CrdManager is a singleton.
    """
    _instance = None
