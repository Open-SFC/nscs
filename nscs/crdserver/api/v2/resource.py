...
def Resource(controller, faults=None, deserializers=None, serializers=None):
    ...
    def resource(request):
        ...
        try:
        ...
        except (exceptions.CrdException,
                netaddr.AddrFormatError) as e:
            LOG.exception(_('%s failed'), action)
            body = serializer.serialize({'CrdError': get_exception_data(e)})
            kwargs = {'body': body, 'content_type': content_type}
            LOG.exception(_('%s failed'), faults)
            for fault in faults:
            ...
            LOG.exception(_('%s failed'), action)
            e.body = serializer.serialize({'CrdError': get_exception_data(e)})
            ...
            body = serializer.serialize({'CrdError': get_exception_data(msg)})
            kwargs = {'body': body, 'content_type': content_type}
            raise webob.exc.HTTPInternalServerError(**kwargs)
