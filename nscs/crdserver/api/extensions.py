...
import nscs.crdserver.extensions
from nscs.crdserver.manager import CrdManager
from nscs.crdserver.openstack.common import log as logging
from nscs.crdserver import wsgi


LOG = logging.getLogger('nscs.crdserver.api.extensions')
...
class RequestExtension(object):
    """Extend requests and responses of core Crd OpenStack API controllers.

    Provide a way to add data to responses and handle custom request data
    that is sent to core Crd OpenStack API controllers.
...
class ActionExtension(object):
    """Add custom actions to core Crd OpenStack API controllers."""
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in Crd."""
...
def get_extensions_path():
    paths = ':'.join(nscs.crdserver.extensions.__path__)
