...
if 'CRDCLIENT_DEBUG' in os.environ and os.environ['CRDCLIENT_DEBUG']:
...
class ServiceCatalog(object):
    ...
    def url_for(self, attr=None, filter_value=None,
                service_type='crd', endpoint_type='adminURL'):
        """Fetch the admin URL from the Crd service for
