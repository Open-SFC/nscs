...
"""
Policy engine for crdservice.  Largely copied from nova.
"""
import itertools
import re
...
import nscs.crdservice.common.utils as utils
...
from nscs.crdservice.openstack.common import policy
...
cfg.CONF.import_opt('policy_file', 'nscs.crdservice.common.config')
