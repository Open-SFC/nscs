...
from nscs.crdservice.openstack.common import context as common_context
...
class ContextBase(common_context.RequestContext):
    ...
    def __init__(self, user_id, tenant_id, is_admin=None, read_deleted="no",
                 roles=None, timestamp=None, auth_token=None, user_name=None, service_catalog=None, **kwargs):
        """
        ...
        super(ContextBase, self).__init__(user=user_id, tenant=tenant_id,
                                          is_admin=is_admin,auth_token=auth_token)
        self.roles = roles or []
