...
from nscs.crdservice.openstack.common import local
from nscs.crdservice.openstack.common import notifier
...
class PublishErrorsHandler(logging.Handler):
    def emit(self, record):
        if ('crdservice.openstack.common.notifier.log_notifier' in
