...
from nscs.crdservice.version import version_info as crd_version
...
core_cli_opts = [
    cfg.StrOpt('state_path', default='/var/lib/crd'),
]
...
rpc.set_defaults(control_exchange='crd')


def parse(args):
    cfg.CONF(args=args, project='crd',
